...
class Ranker:
    ...
    def rank_relevant_docs(relevant_doc):
        ...
        bm25_max=0
        bm25_min=10000
        for val in relevant_doc:
            if relevant_doc[val][1]==1:
                if relevant_doc[val][0] > bm25_max:
                    bm25_max=relevant_doc[val][0]
                if relevant_doc[val][0] < bm25_min:
                    bm25_min = relevant_doc[val][0]
                to_del.append(val)
        bm25=(bm25_min+bm25_max)/2
        for val in to_del:
            relevant_doc.pop(val)
